...
var totalDotCount = 0, dotThreshold = 200;
var iterations = 1, timeStep = 1/70, ground;
...
(function() {
  ...
  /**
    ...
    */
  var countdownTo = new Date(2011, 11, 21, 8, 30, 0).getTime();
  ...
  io.listen('resize', window, function() {
      createGround(world, (window.innerHeight ||
                            document.documentElement.clientHeight) - 280);
